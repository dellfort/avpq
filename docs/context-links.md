# AI Context – Canonical File Index

This file is the single source of truth for AI-assisted review.
All relevant project files must be referenced here as raw GitHub links.

If a file is not listed here, it should be considered irrelevant
or outdated for AI context.

---

## Repository
https://github.com/dellfort/avpq
...
- New files must be added here when they become relevant.
- Removed or obsolete files should be deleted from this list.
- This index defines the **current project state**.
